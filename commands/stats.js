...
exports.run = (client, msg) => {
    ...
    emb.addField('Website', '[Click ME](https://bart-bot.github.io)', true);
    emb.addField('Github', '[Click ME](https://github.com/bart-bot/BartBot)', true);
    emb.addField('Patreon', '[Click ME](https://patreon.com/bartbot)', true);
    emb.addField('Developers', 'GmDb#3353 and ⌬ ᴅ ᴏ ᴄ ⌬#6434', true);
