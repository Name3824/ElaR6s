exports.run = (client, msg) => {
    ...
    emb.addField('**Utility 🤘**', '`invite` `partnerbot` `feedback` `imdb` `weather` `emojilist` `servers` `emoteinfo` `emoteinfo` `ping`', true);
    emb.addField('**Servers 💻**', '`discordbots` `botsfordiscord`', true);
